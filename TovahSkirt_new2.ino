...
int intensityMin = 50;
int intensityCurrent = 100;
int intensityInc = 50; 
int intensityMax = 200; 
...
SimplePatternList gPatterns = {colorPalette2, colorPalette1, confetti, sinelon, juggle, bpm, colorPalette5, colorPalette4, colorPalette7, colorPalette6, colorPalette8 };
